...
import RedesignedPage from "./OrdivyLanding";
import {
  ArrowDown,
  ArrowRight,
  ArrowUpRight,
...
const categories = [
  [PackageOpen, "Comida y despensa"],
  [Snowflake, "Congelador"],
  [Home, "Hogar"],
  [Wrench, "Herramientas"],
  [Shirt, "Ropa y moda"],
  [Palette, "Maquillaje"],
  [Database, "Material de oficina"],
  [Puzzle, "Colecciones"],
];

const features = [
  { icon: ScanLine, number: "3444", title: "Añade", text: "Escanea, busca o crea cualquier objeto en unos segundos." },
...
const faqs = [
  [
    "¿Ordivy es gratis?",
    "Sí. Puedes empezar gratis y organizar tus espacios principales. Premium amplía los límites y añade automatizaciones avanzadas.",
  ],
  [
    "¿Necesito etiquetar todos mis productos?",
    "No. Puedes escanear un código, buscar el producto o añadirlo manualmente. Tú eliges el nivel de detalle.",
  ],
  [
    "¿Dónde se guardan mis datos?",
    "Tu información permanece vinculada a tu dispositivo y Ordivy pide únicamente los permisos necesarios para cada función.",
  ],
...
function LogoSymbolPaths() {
  return (
    <>
      <path
        className="logo-tile"
        d="M480.51 208.76v-20.51c0-39.56-32.07-71.62-71.62-71.62h-20.51c-13.53 0-24.5 10.97-24.5 24.5v67.64c0 13.53 10.97 24.5 24.5 24.5h67.64c13.53 0 24.5-10.97 24.5-24.5Z"
      />
      <path
        className="logo-tile"
        d="M456.01 380.57h-67.64c-13.53 0-24.5 10.97-24.5 24.5v67.64c0 13.53 10.97 24.5 24.5 24.5h32.75c32.8 0 59.38-26.59 59.38-59.38v-32.75c0-13.53-10.97-24.5-24.5-24.5Z"
      />
      <path
        className="logo-tile"
        d="M348.54 208.76v-67.64c0-13.53-9.4-24.5-20.99-24.5h-57.96c-11.59 0-20.99 10.97-20.99 24.5v67.64c0 13.53 9.4 24.5 20.99 24.5h57.96c11.59 0 20.99-10.97 20.99-24.5Z"
      />
      <path
        className="logo-tile"
        d="M248.6 405.06v67.64c0 13.53 9.4 24.5 20.99 24.5h57.96c11.59 0 20.99-10.97 20.99-24.5v-67.64c0-13.53-9.4-24.5-20.99-24.5h-57.96c-11.59 0-20.99 10.97-20.99 24.5Z"
      />
      <rect className="logo-tile" x="363.88" y="248.6" width="116.63" height="116.63" rx="24.5" />
      <path
        className="logo-tile"
        d="M116.63 405.06v32.75c0 32.8 26.59 59.38 59.38 59.38h32.75c13.53 0 24.5-10.97 24.5-24.5v-67.64c0-13.53-10.97-24.5-24.5-24.5h-67.64c-13.53 0-24.5 10.97-24.5 24.5Z"
      />
      <path
        className="logo-tile"
        d="M208.76 116.63h-32.75c-32.8 0-59.38 26.59-59.38 59.38v32.75c0 13.53 10.97 24.5 24.5 24.5h67.64c13.53 0 24.5-10.97 24.5-24.5v-67.64c0-13.53-10.97-24.5-24.5-24.5Z"
      />
...
function OriginWordmark() {
  return (
    <div className="origin-wordmark" role="img" aria-label="Ordivy">
      <span className="origin-vector-pair origin-vector-pair--or">
        <img src="/ordivy-wordmark.svg" alt="" />
      </span>
      <span className="origin-vector-pair origin-vector-pair--di">
        <img src="/ordivy-wordmark.svg" alt="" />
      </span>
      <span className="origin-vector-pair origin-vector-pair--vy">
        <img src="/ordivy-wordmark.svg" alt="" />
      </span>
    </div>
  );
...
function PhonePreview({ compact = false }) {
  return (
    <div className={`phone-stage ${compact ? "phone-stage--compact" : ""}`} aria-label="Vista conceptual de la aplicación Ordivy">
      ...
      {!compact && (
        <>
          <div className="product-chip product-chip--coffee">
            <span>
              <Wrench size={16} />
            </span>
            <div>
              <b>Taladro</b>
              <small>Trastero</small>
            </div>
            <Check size={15} />
          </div>
          <div className="product-chip product-chip--list">
            <span>
              <Puzzle size={16} />
            </span>
            <div>
              <b>Colección LEGO</b>
              <small>56 piezas</small>
            </div>
            <ArrowRight size={15} />
          </div>
        </>
        ...
        <div className="phone-screen">
          ...
          <div className="app-home-head">
            <div>
              <small>HOGAR</small>
              <b>Mi casa</b>
              <span>Todo lo que tienes, en su sitio.</span>
            </div>
            <i>
              <Home size={18} />
            </i>
          ...
          <div className="inventory-pills">
            <span className="active">
              <Home size={13} /> Mi casa
            </span>
            <span>
              <Database size={13} /> Oficina
            </span>
          </div>
          <div className="restock-card">
            ...
            <div>
              <b>3 productos por reponer</b>
              <small>Ver lista de compra</small>
            </div>
            <ArrowRight size={13} />
          </div>
          <div className="phone-section-title">
...
export function LegacyOrdivyPage() {
  return (
    <main>
      <MotionController />
        ...
        <div className="hero-layout shell">
          <div className="hero-copy">
            ...
            <h1>
              Todo lo que tienes,
              <br />
              <span>siempre bajo control.</span>
            </h1>
            <p className="hero-lede">
              Organiza cada rincón de casa, encuentra cualquier cosa en segundos y controla cantidades, mínimos y productos en uso desde un solo
              lugar.
            </p>
            <a className="hero-cta" href="#idea">
              Descubrir Ordivy <ArrowDown size={17} />
            </a>
            <p className="hero-note">
              <Check size={14} /> Tus datos empiezan contigo, en tu dispositivo.
            </p>
          </div>
          <PhonePreview />
        </div>
        <a className="scroll-cue" href="#idea" aria-label="Descubrir más">
      ...
      <section className="idea-section section" id="idea">
        <div className="shell idea-layout">
          <SectionTitle
            label="MUCHO MÁS QUE UNA DESPENSA"
            title={
              <>
                No solo la comida.
                <br />
            ...
            copy="Ropa, herramientas, documentos, material de oficina, colecciones o productos cotidianos. Ordivy se adapta a lo que tú quieras organizar."
          />
          <div className="origin-stage">
            ...
            <p className="origin-copy">
              Ordenar. Marcar la diferencia.
              <br />
              Tener el inventario de tu mundo.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="world-section section">
        <div className="shell world-head">
          <SectionTitle
            ...
            copy="Crea inventarios para casa, oficina o cualquier otro lugar. Dentro de cada uno, organiza por habitaciones, armarios, cajas o zonas reales."
          />
        ...
        <div className="category-track shell" aria-label="Ejemplos de categorías">
          <div className="category-row">
            {categories.map(([Icon, label], index) => (
              <div className={`category-card category-card--${index + 1}`} key={label}>
        ...
        <div className="shell steps-layout">
          <div className="steps-visual reveal-on-scroll">
            <div className="scan-card">
              ...
              <ScanLine />
              <b>Taladro</b>
              <small>Objeto reconocido</small>
            </div>
            <div className="steps-phone">
              <div className="mini-notch" />
              <p>Inventario · Trastero</p>
              <div className="shopping-item">
                <span>🔧</span>
                <div>
                  <b>Taladro</b>
                  <small>Estante superior</small>
                </div>
                <Check size={15} />
              </div>
              <div className="shopping-item">
                ...
                <div>
                  <b>Cinta métrica</b>
                  <small>Caja de herramientas</small>
                </div>
          ...
          <div className="steps-copy">
            ...
            <ol className="step-list">
              <li>
                <span>01</span>
                <div>
                  <h3>Escanea, busca o crea</h3>
                  <p>Añade comida, ropa, herramientas o cualquier otra cosa.</p>
                </div>
              </li>
              <li>
                <span>02</span>
                <div>
                  <h3>Elige su lugar</h3>
                  <p>Asigna el inventario, la ubicación y los datos que te importan.</p>
                </div>
              </li>
              <li>
                <span>03</span>
                <div>
                  <h3>Deja que Ordivy recuerde</h3>
                  <p>Consulta, repón y aprovecha sin depender de tu memoria.</p>
                </div>
              </li>
            </ol>
          </div>
      ...
      <section className="features-section section" id="funciones">
        <div className="shell">
          <SectionTitle
            ...
            copy="Ordivy acompaña el recorrido completo: guardar, encontrar, reponer y aprovechar mejor lo que ya tienes."
          />
          <div className="feature-grid">
            {features.map(({ icon: Icon, number, title, text }) => (
              <article className="feature-card reveal-on-scroll" key={title}>
      ...
      <section className="premium-section section" id="premium">
        <div className="shell premium-panel">
          <div className="premium-copy">
            <p className="eyebrow">ORDIVY PREMIUM</p>
            <h2>
              Más orden.
              <br />
            ...
            <ul>
              <li>
                <Check /> Inventarios ilimitados
              </li>
              <li>
                <Check /> Avisos inteligentes
              </li>
              <li>
                <Check /> Espacios compartidos
              </li>
            </ul>
            <a className="light-button" href="#descargar">
              Descubrir Premium <ArrowRight size={17} />
            </a>
          </div>
          <div className="premium-art" aria-hidden="true">
            <div className="premium-ring ring-a" />
            <div className="premium-ring ring-b" />
            <Sparkles />
            <span>
              Todo fluye
              <br />
      ...
      <section className="privacy-section section" id="privacidad">
        <div className="shell privacy-panel">
          ...
          <div>
            <p className="eyebrow eyebrow--dark">TUS DATOS, TU TRANQUILIDAD</p>
            <h2>Privacidad por diseño.</h2>
            <p>Tu inventario es tuyo. Pedimos únicamente los permisos necesarios y explicamos para qué se utiliza cada uno.</p>
          </div>
          <div className="privacy-points">
            <div>
              <LockKeyhole />
              <span>
                <b>Control siempre contigo</b>
                <small>Decide qué compartes y cuándo.</small>
              </span>
            </div>
            <div>
              <BellRing />
              <span>
                <b>Solo avisos útiles</b>
                <small>Sin ruido ni notificaciones innecesarias.</small>
              </span>
            </div>
          </div>
        </div>
      ...
      <section className="faq-section section" id="faq">
        <div className="shell faq-layout">
          <SectionTitle
            ...
            copy="Lo esencial sobre Ordivy, sin letra pequeña."
          />
      ...
      <section className="download-section section" id="descargar">
        <div className="shell download-panel">
          <div className="download-copy">
            ...
            <p>El orden marca la diferencia.</p>
